...
(function(){
  ...
  const islanderbt = path.endsWith('/landerbt.html');

  if (!isIndex && !islanderbt) return;
  ...
  if (islanderbt) {
    // ✅ landerbt → redirect
    const redirectUrl = "https://p8r9.com/?utm_campaign=CkPgmfOcNB&v1=[v1]&v2=[v2]&v3=[v3]"; // always use full URL
